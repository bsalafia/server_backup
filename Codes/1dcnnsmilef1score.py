...
for trainindx, testindx in kfold.split(range(24)):
    ...
    ModelName2='CNN6foldV2'+ str(fold_no)+'.h5'
    model2=tf.keras.models.load_model(os.path.join(modeldir,ModelName2))

    ModelName3='CNNSMILE6foldDiffV2'+str(fold_no)+'.h5'
    ...
    ModelName5='CNN6foldsmilediffonlyV2'+str(fold_no)+'.h5'
...
np.save(os.path.join(SaveResults, 'f1_score_smileV2'),  f1_score_smile)
np.save(os.path.join(SaveResults, 'Precision_smileV2'), Precision_smile)
np.save(os.path.join(SaveResults, 'Recall_smileV2'), Recall_smile)

np.save(os.path.join(SaveResults, 'f1_score_smileonlyV2'),  f1_score_smileonly)
np.save(os.path.join(SaveResults, 'Precision_smileonlyV2'), Precision_smileonly)
np.save(os.path.join(SaveResults, 'Recall_smileonlyV2'), Recall_smileonly)

np.save(os.path.join(SaveResults, 'f1_score_smileonlydiffV2'),  f1_score_smileonlydiff)
np.save(os.path.join(SaveResults, 'Precision_smileonlydiffV2'), Precision_smileonlydiff)
np.save(os.path.join(SaveResults, 'Recall_smileonlydiffV2'), Recall_smileonlydiff)

np.save(os.path.join(SaveResults, 'f1_score_smilediffV2'),  f1_score_smilediff)
np.save(os.path.join(SaveResults, 'Precision_smilediffV2'), Precision_smilediff)
np.save(os.path.join(SaveResults, 'Recall_smilediffV2'), Recall_smilediff)


np.save(os.path.join(SaveResults, 'f1_score_cnnV2'),  f1_score_cnn)
np.save(os.path.join(SaveResults, 'Precision_cnnV2'), Precision_cnn)
np.save(os.path.join(SaveResults, 'Recall_cnnV2'), Recall_cnn)
