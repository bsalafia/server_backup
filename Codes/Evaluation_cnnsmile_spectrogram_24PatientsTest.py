...
def Xtrain(cnn,smile,diff,twodcnn,spectrogram,gru,x,y,mi,mi_diff,spec):
...
def ModelTrain(dirname,dirname2,modeldir,SaveResults,SaveResultsTruePred,modelname,seq_len,cnn,smile,diff,twodcnn,spectrogram,indx,gru,epoch,l2_size,drop_size,batchSize):
  ...
  #
  #
  #     X_train=Xtrain(cnn,smile,diff,twodcnn,spectrogram,gru,X,Y,MI_all,MI_diff_all,spec)
  #
  ...
  #       x, y, mi,mi_diff,spec=ReadMatFiles(dirname,dirname2,ind,seq_len,diff)
  #
  #       X_train=Xtrain(cnn,smile,diff,twodcnn,spectrogram,gru,x[j],y[j],mi[j],mi_diff[j],spec[j])
  #
  #       ModelName1=modelname+'_fold'+str(fold_no)+'_epoch_'+str(epoch)+'_l2Size_'+str(l2_size)+'_DropSize_'+str(drop_size)+'_batchsize_'+str(batchSize)+'.h5'
  #
  #       model1=tf.keras.models.load_model(os.path.join(modeldir,ModelName1))
  ...
  #
  #
  #     plt.suptitle(modelname+'_EDFNo_'+str(j+1)+'_epoch_'+str(epoch)+'_'+indx+'_l2Size_'+str(l2_size)+'_DropSize_'+str(drop_size)+'_batchsize_'+str(batchSize))
  #
  #     plt.savefig(SaveResultsTruePred+'/'+modelname+'_EDFNo_'+str(j+1)+'_epoch_'+str(epoch)+'_'+indx+'_l2Size_'+str(l2_size)+'_DropSize_'+str(drop_size)+'_batchsize_'+str(batchSize)+'.pdf', format='pdf', bbox_inches = 'tight')
  #     plt.clf()
  #
  #
...
modeldir='/home/baharsalafian/CNNSMILEGRUModels_24TestFiles_JBHI_test'

SaveResults='/home/baharsalafian/Results_24TestFiles_JBHI_test'
SaveResultsTruePred='/home/baharsalafian/TruePredPlots_24TestFiles_JBHI_test'
i=0
k=None
j=256

ModelTrain(dirname,dirname2,modeldir,SaveResults,SaveResultsTruePred,'CNN_Spectrogram10times',seq_len=1,cnn=0,smile=0,diff=0,twodcnn=0,spectrogram=1,indx='test',gru=0,epoch=250,l2_size=k,drop_size=i,batchSize=j)
