...
def Xtrain(cnn,smile,diff,twodcnn,cnnsmilespect,x,y,mi,mi_diff,Spect_all):
...
def ModelTrain(dirname,dirname2,modeldir,SaveResults,SaveResultsTruePred,modelname,seq_len,cnn,smile,diff,twodcnn,cnnsmilespect,smile_new_arch,indx,gru,Noepoch,batch_size):
  ...
  for th in [0.5]:
    ...
    for trainindx, testindx in kfold.split(range(24)):
      ...
      model1=tf.keras.models.load_model(os.path.join(modeldir,ModelName1),custom_objects = None)
      # X=np.concatenate(x,axis=0)
      fpr=[]
      tpr=[]
      PR=[]
      ...
      for k in range(len(x)):
        ...
        X_train=Xtrain(cnn,smile,diff,twodcnn,cnnsmilespect,X,Y,MI_all,MI_diff_all,Spect_all)
  ...
  for trainindx, testindx in kfold.split(range(24)):
    ...
    for j in [0,8,11]:
      ...
      X_train=Xtrain(cnn,smile,diff,twodcnn,cnnsmilespect,x[j],y[j],mi[j],mi_diff[j],spect[j])
      ModelName1=modelname+'_fold'+str(fold_no)+'_epoch_'+str(Noepoch)+'_batchsize_'+str(batch_size)+'.h5'
...
modeldir='/home/baharsalafian/CustomMetrics_model_fit_generator_6fold'

SaveResults='/home/baharsalafian/Results_JBHI_6Fold_CustomMetrics_Oversample'

SaveResultsTruePred='/home/baharsalafian/TruePredPlots_JBHI_6Fold_CustomMetrics_Oversample'

ModelTrain(dirname,dirname2,modeldir,SaveResults,SaveResultsTruePred,'CNN_SMILE_NewArch_6Fold',seq_len=1,cnn=0,smile=0,diff=0,twodcnn=0,cnnsmilespect=0,smile_new_arch=1,indx='test',gru=0,Noepoch=100,batch_size=256)
