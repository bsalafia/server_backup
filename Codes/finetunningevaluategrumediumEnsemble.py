...
def FineTuning(SaveResults,modelname,fold_no,x1,y1,mi1,mi_diff1,batchsize,epoch,Xtest,MItest,MItest_diff,cnn,smile,diff,twodcnn):
...
def ReadMatFiles(dirname,SaveResults,indx, testindx,fold_no,modelname,batchsize,epoch ,cnn,smile,diff,seq_len,twodcnn):
  ...
  for k in range(len(ind)):
    ...
    ypred=FineTuning(SaveResults,modelname,fold_no,x1,y1,mi1,mi_diff1,batchsize,epoch,Xtest,MItest,MItest_diff,cnn,smile,diff,twodcnn)
...
def ModelTrain(dirname,SaveResults,indx,modelname,batchsize,epoch):
  ...
  for th in [0.5,0.7]:
    ...
    for trainindx, testindx in kfold.split(range(24)):
      ...
      fold_no=fold_no+1
      modelnamecnn='CNNGRU10times'
      modelnamesmile='CNNSMILEGRU10times'
      modelnamediff='CNNSMILEDiffGRU10times'
      ytest_cnn,ypred_cnn=ReadMatFiles(dirname,SaveResults,indx,trainindx, fold_no,modelnamecnn,batchsize,epoch ,cnn=1,smile=0,diff=0,seq_len=3,twodcnn=0)
      ytest_smile,ypred_smile=ReadMatFiles(dirname,SaveResults,indx,trainindx, fold_no,modelnamesmile,batchsize,epoch ,cnn=0,smile=1,diff=0,seq_len=3,twodcnn=0)
      ytest_diff,ypred_diff=ReadMatFiles(dirname,SaveResults,indx,trainindx, fold_no,modelnamediff,batchsize,epoch ,cnn=0,smile=0,diff=1,seq_len=3,twodcnn=0)
...
# seq_len=7
ModelTrain(dirname,SaveResults,'train_finetune_medium','EnsembleModelGRU',batchsize=256,epoch=4)
