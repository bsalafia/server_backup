...
#
  ...
  model.fit([X_train,mi_train],ytrain,validation_split=0.2,batch_size=batchsize , epochs=epoch,verbose = 2)
  ...
  score.append(acc)
  loss1.append(loss)
  model.save('/home/baharsalafian/GRURes/CNNSMILEGRU3times'+ str(fold_no)+'.h5')
  fold_no=fold_no+1
...
np.save(os.path.join(SaveResults,'accuracyCNNSMILEGRU3times'),score)
np.save(os.path.join(SaveResults,'lossCNNSMILEGRU3times'),loss1)
