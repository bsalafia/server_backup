...
#############################################
  ...
  np.savez(os.path.join(SaveHisResults, 'HistoryRes_'+modelname+'_epoch_'+str(epoch)+'_l2Size_'+str(l2_size)+'_DropSize_'+str(drop_size)+'_batchsize_'+str(batchSize)), loss=loss, loss_val=loss_val, accuracy=acc, accuracy_val=acc_val, LR=LR)
...
SaveResults='/home/baharsalafian/CNNSMILEGRUModels_24TestFiles_JBHI_LRtest'
SaveHisResults='/home/baharsalafian/History_24TestFiles_JBHI_LRtest'

ModelTrain(dirname,dirname2,SaveResults,SaveHisResults,'CNNSMILE10times_Decay.5_LR.0001',seq_len=1,cnn=0,smile=1,diff=0,twodcnn=0,spectrogram=0,gru=0,epoch=100,l2_size=k,drop_size=i,batchSize=j)
