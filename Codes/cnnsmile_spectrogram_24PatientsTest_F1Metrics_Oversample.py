...
SaveHisResults='/home/baharsalafian/History_JBHI_LossTest_Metrics'

ModelTrain(dirname,dirname2,SaveResults,SaveHisResults,'CNNSMILE10times_Decay.5_LR.0001_24Testfiles_Metric_SMOTE_Oversample',seq_len=1,cnn=0,smile=1,diff=0,twodcnn=0,spectrogram=0,cnnsmilespec=0,gru=0,epoch=100,epochLoad=0,l2_size=k,drop_size=i,batchSize=j)
