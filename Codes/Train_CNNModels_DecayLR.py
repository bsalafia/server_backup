...
#############################################
  ...
  np.savez(os.path.join(SaveHisResults, 'HistoryRes_'+modelname+'_epoch_'+str(epoch+epochLoad)+'_l2Size_'+str(l2_size)+'_DropSize_'+str(drop_size)+'_batchsize_'+str(batchSize)), loss=loss, loss_val=loss_val, accuracy=acc, accuracy_val=acc_val, LR=LR)
...
SaveResults='/home/baharsalafian/CNNSMILEGRUModels_JBHI_6FoldLRTest'
SaveHisResults='/home/baharsalafian/History_JBHI_LossTest_6FoldLRTest'

ModelTrain(dirname,SaveResults,SaveHisResults,modeldir,'CNNSMILE10times_Decay.5_lr.001_NoAct','CNNSMILE10times_lr.001_NoAct',seq_len=1,cnn=0,smile=1,diff=0,twodcnn=0,epoch=150, epochLoad=0,l2_size=k,drop_size=i,batchSize=j)
