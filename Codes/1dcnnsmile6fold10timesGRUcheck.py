...
##################################################################
  ...
  encoded_sequence = Bidirectional(GRU(30, return_sequences=True))(encoded_frames)
  output=TimeDistributed(Dense(1,activation='sigmoid'))(encoded_sequence)
...
#
  ...
  loss, acc = model.evaluate([X_test,mi_test],Y_test, verbose=2)
  score.append(acc)
  loss1.append(loss)
  model.save('/home/baharsalafian/GRURes/CNNSMILEGRU10times30Noth'+ str(fold_no)+'.h5')
  fold_no=fold_no+1
...
np.save(os.path.join(SaveResults,'accuracyCNNSMILEGRU10times30Noth'),score)
np.save(os.path.join(SaveResults,'lossCNNSMILEGRU10times30Noth'),loss1)
