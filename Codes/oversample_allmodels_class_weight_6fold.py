...
SaveHisResults='/home/baharsalafian/Custom_results_class_weight_6fold'
ModelResults='/home/baharsalafian/Custom_model_class_weight_6fold'


modelname='CNNSMILESpectrogram_6Fold_class_weight'
initLR=0.01
cnn=0
smile=0
spectrogram=0
...
for trainindx, testindx in kfold.split(range(24)):
  ...
  x_train=Make_X(X_train,mi,spec_train,cnn,smile,spectrogram,cnnsmilespec,twodcnn)
  x_test=Make_X(X_test, mitest,spec_test,cnn,smile,spectrogram,cnnsmilespec,twodcnn)
  ...
  history=model.fit(x_train, y_train, validation_data=(x_test,y_test),batch_size=batchsize,epochs=num_epochs,class_weight=class_weights,callbacks=[history_logger,LearningRateScheduler(lr_exp_decay,verbose=2)])
