...
savedir='/home/baharsalafian/SMILELabel/'
  ...
  for z in train[train_indx]:
    ...
    for q in range(len(WindowSize)):
      for file_idx in range(len(indices)):
        ...
        savemat(os.path.join(savedir, Name[0]+'MI_RollWindow'+str(WindowSize[0])+'_NNdim'+str(critic_params['NNdim'])+'_FoldNo{}_MaxEpoch{}_MinEpoch{}.mat'.format(train_indx+1,init_epoch,rest_epoch)), {"Y_label": Y_train ,"Y_label_4sec": Ylabel_4sec,"X_4sec": X_4sec})
