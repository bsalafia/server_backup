...
modeldir='/home/baharsalafian/GRURes'
...
for trainindx, testindx in kfold.split(range(24)):
  ...
  X_test,Y_test,mi_test,midiff = ReadMatFilesDiff(dirname,trainindx)
  ...
  ypred1=model1.predict([X_test,mi_test,midiff])
  ytest = ytest[:, 2]  ###### Get the last element of the sequence of length 3
  ytest=ytest.reshape(ytest.shape[0],1)
  ypred1= ypred1[:, 2]  ###### Get the last element of the sequence of length 3
...
np.save(os.path.join(SaveResults, 'fpr_cnnsmilediff10timesGRUtrain'),  fpr)
np.save(os.path.join(SaveResults, 'tpr_cnnsmilediff10timesGRUtrain'),  tpr)
np.save(os.path.join(SaveResults, 'PR_cnnsmilediff10timesGRUtrain'), PR)
np.save(os.path.join(SaveResults, 'ROC_cnnsmilediff10timesGRUtrain'),  ROC)
