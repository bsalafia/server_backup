...
def ModelTrain(dirname,SaveResults,modelname,seq_len,cnn,smile,diff,twodcnn,indx):
  fpr=[]
  tpr=[]
  PR=[]
  ROC=[]
...
ModelTrain(dirname,SaveResults,'2DCNN10times',seq_len=1,cnn=0,smile=0,diff=0,twodcnn=1,indx='test')
