...
#
  ...
  score.append(acc)
  loss1.append(loss)
  model.save('/home/baharsalafian/GRURes/CNNGRU3times'+ str(fold_no)+'.h5')
  fold_no=fold_no+1
...
np.save(os.path.join(SaveResults,'accuracyCNNGRU3times'),score)
np.save(os.path.join(SaveResults,'lossCNNGRU3times'),loss1)
