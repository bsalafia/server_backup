...
################################################################
  ...
  drop2=Dropout(drop_size)(denseout1)

  denseout2 = Dense(50, activation='relu')(drop2)
  drop3=Dropout(drop_size)(denseout2)
...
def define_CNN(l2_size,drop_size):
  ...
  flat=Flatten()(drop1)
  denseout1 = Dense(100, activation='relu')(flat)
  drop2=Dropout(drop_size)(denseout1)
...
for i in [0.1,0.25,0.5]:
  ...
  for j in [256,512]:
    ...
    for k in [0.001,0.01]:
      ...
      SaveResults='/home/baharsalafian/CNNSMILEGRU100Epoch_L2DropExperiment_NewVersion'
