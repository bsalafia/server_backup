...
def ReadMatFiles(dirname,ind, seq_len=1,diff=None):
...
def ModelTrain(dirname,modeldir,SaveResults,SaveResultsTruePred,modelname,seq_len,cnn,smile,diff,twodcnn,indx,gru,Noepoch,l2_size,drop_size,batchSize):
  ...
  for i in range(2):
    ...
    ModelName1=modelname+'_fold'+str(fold_no)+'_epoch_'+str(Noepoch)+'_batchsize_'+str(batchSize)+'_l2size_'+str(l2_size)+'_dropsize_'+str(drop_size)+'Noise'+str(noise)+'.h5'
...
SaveResultsTruePred='/home/baharsalafian/JBHI_LabelsForEyal_All_Patient_train'

SaveResults='/home/baharsalafian/JBHI_LabelsForEyal_All_Patient_train'

i=0
k=None
j=256

ModelTrain(dirname,modeldir,SaveResults,SaveResultsTruePred,'CNN_SMILE_MoreDense_24Testfiles_init_0.0001',seq_len=1,cnn=0,smile=1,diff=0,twodcnn=0,indx='test',gru=0,Noepoch=100,l2_size=k,drop_size=i,batchSize=j)
