...
j=256
# n=0
ModelTrain(dirname,dirname2,dirprobs,modeldir,SaveResults,SaveResultsTruePred,'JBHI_all_patients_train_CNN','CNNFG_24Testfiles_init_0.0001',seq_len=1,cnn=1,smile=0,diff=0,twodcnn=0,spectrogram=0,cnnsmilespect=0,indx='test',gru=0,epoch=100,l2_size=k,drop_size=i,batchSize=j,noise=0)
