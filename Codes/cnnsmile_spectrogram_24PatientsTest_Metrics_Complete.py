...
ModelTrain(dirname,dirname2,SaveResults,SaveHisResults,'CNNSMILESpec10times_Decay.5_LR.001_24Testfiles',seq_len=1,cnn=0,smile=1,diff=0,twodcnn=0,spectrogram=0,cnnsmilespec=0,gru=0,epoch=150,epochLoad=0,l2_size=k,drop_size=i,batchSize=j)
