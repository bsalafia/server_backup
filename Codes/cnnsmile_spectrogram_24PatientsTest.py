...
SaveResults='/home/baharsalafian/CNNSMILEGRUModels_24TestFiles_JBHI_Losstest'
SaveHisResults='/home/baharsalafian/History_24TestFiles_JBHI_Losstest'

ModelTrain(dirname,dirname2,SaveResults,SaveHisResults,'CNNSMILE10times_lr.00001',seq_len=1,cnn=0,smile=1,diff=0,twodcnn=0,spectrogram=0,gru=0,epoch=200,l2_size=k,drop_size=i,batchSize=j)
