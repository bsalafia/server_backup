...
ModelTrain(dirname,SaveResults,SaveHisResults,'CNN10times_lr.00001',seq_len=1,cnn=1,smile=0,diff=0,twodcnn=0,epoch=200,l2_size=k,drop_size=i,batchSize=j)
