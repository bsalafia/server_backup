...
################################################################
  ...
  model.compile(optimizer=Adam(learning_rate=0.00001),loss='binary_crossentropy',metrics=["accuracy", tf.keras.metrics.AUC(curve="ROC",name='auc_roc'),tf.keras.metrics.AUC(curve="PR",name='auc_pr'),tf.keras.metrics.Precision(name="precision"),tf.keras.metrics.Recall(name="recall")])
  return model
...
def ModelTrain(dirname,dirname2,SaveResults,SaveHisResults,modelname,seq_len,cnn,smile,diff,twodcnn,spectrogram,cnnsmilespec,gru,epoch,epochLoad,l2_size,drop_size,batchSize,init_epoch,initLR):
  ...
  for i in range(2):
    ...
    print("for train, x,mi,spec_train",x.shape, mi.shape,spec_train.shape)
#
    if cnn==1:
    ...
    if smile==1:
      # tf.keras.backend.clear_session()
      # ModelName1=modelnamePretrained+ '_fold'+str(fold_no)+'_epoch_'+str(epoch)+'.h5'
      model=define_SMILE(l2_size,drop_size)
      modelpretrained=tf.keras.models.load_model(SaveResults+'/'+modelname+'_fold'+str(fold_no)+'_epoch_'+str(init_epoch)+'_l2Size_'+str(l2_size)+'_DropSize_'+str(drop_size)+'_batchsize_'+str(batchSize)+'.h5')
      weights=modelpretrained.get_weights()
...
####################################
    print("Train and Test Shapes", y.shape, ytest.shape)
    ##################################################################
...
########################################
    ...
    print("total Train",X_train[0].shape,X_train[1].shape)

    filename='history'+modelname+'_fold'+str(fold_no)+'_epoch_'+str(epoch+init_epoch)+'_LR_'+str(initLR)+'_batchsize_'+str(batchSize)+'.csv'

    history_logger=tf.keras.callbacks.CSVLogger(filename, separator=",", append=False)
    if gru==1:
      history=modelpretrained.fit(X_train, y, validation_data=(X_test,ytest), batch_size=batchsize, epochs=epoch, sample_weight=sample_weight, callbacks=[LearningRateScheduler(lr_exp_decay, verbose=2)])
    else:

      history=model.fit(X_train, y, validation_data=(X_test,ytest), batch_size=batchsize, epochs=epoch,class_weight=class_weights, callbacks=[history_logger,LearningRateScheduler(lr_exp_decay, verbose=2)])


    np.save(os.path.join(SaveHisResults, 'history'+modelname+'_fold'+str(fold_no)+'_epoch_'+str(epoch+init_epoch)+'_LR_'+str(initLR)+'_batchsize_'+str(batchSize)+'.npy'), history.history)

    model.save(SaveResults+'/'+modelname+'_fold'+str(fold_no)+'_LR_'+str(initLR)+'_epoch_'+str(epoch+init_epoch)+'_l2Size_'+str(l2_size)+'_DropSize_'+str(drop_size)+'_batchsize_'+str(batchSize)+'.h5')
...
#############################################
  ...
  plt.title(modelname+'_accuracy'+'_epoch_'+str(epoch+init_epoch)+'_l2Size_'+str(l2_size)+'_DropSize_'+str(drop_size)+'_batchsize_'+str(batchSize))
  ...
  plt.ylabel('%')
  plt.xlabel('epoch')
  plt.savefig(SaveHisResults+'/'+'history_'+modelname+'_accuracy'+'_epoch_'+str(epoch+init_epoch)+'_l2Size_'+str(l2_size)+'_DropSize_'+str(drop_size)+'_batchsize_'+str(batchSize)+'.pdf', format='pdf', bbox_inches = 'tight')
  plt.clf()

  plt.plot(loss_mean)
  plt.plot(loss_val_mean)
  plt.title(modelname+'_loss'+'_epoch_'+str(epoch+init_epoch)+'_l2Size_'+str(l2_size)+'_DropSize_'+str(drop_size)+'_batchsize_'+str(batchSize))
  plt.legend(['train', 'test'], loc='upper left')
  ...
  plt.ylabel('%')
  plt.xlabel('epoch')
  plt.savefig(SaveHisResults+'/'+'history_'+modelname+'_loss'+'_epoch_'+str(epoch+init_epoch)+'_l2Size_'+str(l2_size)+'_DropSize_'+str(drop_size)+'_batchsize_'+str(batchSize)+'.pdf', format='pdf', bbox_inches = 'tight')
  plt.clf()
  ###############3
  plt.plot(f1_mean)
  plt.plot(f1_val_mean)
  plt.title(modelname+'_F1 score'+'_epoch_'+str(epoch+init_epoch)+'_l2Size_'+str(l2_size)+'_DropSize_'+str(drop_size)+'_batchsize_'+str(batchSize))
  plt.legend(['train', 'test'], loc='upper left')
  ...
  plt.ylabel('%')
  plt.xlabel('epoch')
  plt.savefig(SaveHisResults+'/'+'history_'+modelname+'_F1 score'+'_epoch_'+str(epoch+init_epoch)+'_l2Size_'+str(l2_size)+'_DropSize_'+str(drop_size)+'_batchsize_'+str(batchSize)+'.pdf', format='pdf', bbox_inches = 'tight')
  plt.clf()
 #############
...
#####
  ...
  plt.title(modelname+'_Precision'+'_epoch_'+str(epoch+init_epoch)+'_l2Size_'+str(l2_size)+'_DropSize_'+str(drop_size)+'_batchsize_'+str(batchSize))
  plt.legend(['train', 'test'], loc='upper left')
  ...
  plt.ylabel('%')
  plt.xlabel('epoch')
  plt.savefig(SaveHisResults+'/'+'history_'+modelname+'_Precision'+'_epoch_'+str(epoch+init_epoch)+'_l2Size_'+str(l2_size)+'_DropSize_'+str(drop_size)+'_batchsize_'+str(batchSize)+'.pdf', format='pdf', bbox_inches = 'tight')
  plt.clf()
#################3

  plt.plot(recall_mean)
  plt.plot(recall_val_mean)
  plt.title(modelname+'_Recall'+'_epoch_'+str(epoch+init_epoch)+'_l2Size_'+str(l2_size)+'_DropSize_'+str(drop_size)+'_batchsize_'+str(batchSize))
  plt.legend(['train', 'test'], loc='upper left')
  ...
  plt.ylabel('%')
  plt.xlabel('epoch')
  plt.savefig(SaveHisResults+'/'+'history_'+modelname+'_Recall'+'_epoch_'+str(epoch+init_epoch)+'_l2Size_'+str(l2_size)+'_DropSize_'+str(drop_size)+'_batchsize_'+str(batchSize)+'.pdf', format='pdf', bbox_inches = 'tight')
  plt.clf()
###############
  plt.plot(PR_mean)
  plt.plot(PR_val_mean)
  plt.title(modelname+'_PR'+'_epoch_'+str(epoch+init_epoch)+'_l2Size_'+str(l2_size)+'_DropSize_'+str(drop_size)+'_batchsize_'+str(batchSize))
  plt.legend(['train', 'test'], loc='upper left')
  ...
  plt.ylabel('%')
  plt.xlabel('epoch')
  plt.savefig(SaveHisResults+'/'+'history_'+modelname+'_PR'+'_epoch_'+str(epoch+init_epoch)+'_l2Size_'+str(l2_size)+'_DropSize_'+str(drop_size)+'_batchsize_'+str(batchSize)+'.pdf', format='pdf', bbox_inches = 'tight')
  plt.clf()
######
  plt.plot(ROC_mean)
  plt.plot(ROC_val_mean)
  plt.title(modelname+'_ROC'+'_epoch_'+str(epoch+init_epoch)+'_l2Size_'+str(l2_size)+'_DropSize_'+str(drop_size)+'_batchsize_'+str(batchSize))
  plt.legend(['train', 'test'], loc='upper left')
  ...
  plt.ylabel('%')
  plt.xlabel('epoch')
  plt.savefig(SaveHisResults+'/'+'history_'+modelname+'_ROC'+'_epoch_'+str(epoch+init_epoch)+'_l2Size_'+str(l2_size)+'_DropSize_'+str(drop_size)+'_batchsize_'+str(batchSize)+'.pdf', format='pdf', bbox_inches = 'tight')
  plt.clf()



  plt.plot(LR_mean)
  plt.title(modelname+'_LR'+'_epoch_'+str(epoch+init_epoch)+'_l2Size_'+str(l2_size)+'_DropSize_'+str(drop_size)+'_batchsize_'+str(batchSize))
  plt.legend(['lr'], loc='upper left')
  plt.fill_between(range(epoch), LR_mean-LR_std, LR_mean+LR_std, color='orange', alpha = 0.5)

  plt.ylabel('lr')
  plt.xlabel('epoch')
  plt.savefig(SaveHisResults+'/'+'history_'+modelname+'_LR'+'_epoch_'+str(epoch+init_epoch)+'_l2Size_'+str(l2_size)+'_DropSize_'+str(drop_size)+'_batchsize_'+str(batchSize)+'.pdf', format='pdf', bbox_inches = 'tight')
  plt.clf()
...
ModelTrain(dirname,dirname2,SaveResults,SaveHisResults,'CNNSMILESpectrogram10times_Decay.5_LR.001_24Testfiles_KerasMet',seq_len=1,cnn=0,smile=0,diff=0,twodcnn=0,spectrogram=0,cnnsmilespec=1,gru=0,epoch=500,epochLoad=0,l2_size=k,drop_size=i,batchSize=j,init_epoch=1000,initLR=0.00001)
