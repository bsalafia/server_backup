...
np.save(os.path.join(SaveResults, 'fpr_cnnsmile3timesGRUtrain'),  fpr)
np.save(os.path.join(SaveResults, 'tpr_cnnsmile3timesGRUtrain'),  tpr)
np.save(os.path.join(SaveResults, 'PR_cnnsmile3timesGRUtrain'), PR)
np.save(os.path.join(SaveResults, 'ROC_cnnsmile3timesGRUtrain'),  ROC)
