...
def ReadMatFiles(dirname,dirname2,SaveResults,indx, testindx,fold_no,modelname,batchsize,epoch ,cnn,smile,diff,seq_len):
  ...
  return X_test,Y_test,MI_test,Spec_test
...
def ModelTrain(dirname,dirname2,modeldir,SaveResults,SaveResultsTruePred,modelname,LR,seq_len,cnn,smile,diff,smile_new_arch,twodcnn,spectrogram,indx,gru,epoch,l2_size,drop_size,batchSize):
  ...
  for testindx in range(24):
    ...
    if indx=='test':
      ...
      ind=trainindx
    Xtest,Ytest,MItest,Spectest=ReadMatFiles(dirname,dirname2,SaveResults,indx,testindx, fold_no,modelname,batchSize,epoch ,cnn,smile,diff,seq_len)
    ...
    savemat(os.path.join(SaveResults, 'LabelPred_'+modelname+'_'+indx+'_'+str(fold_no)+'.mat'), { 'True'+'Lables': Ytest ,'Predicted'+'Lables':ypred})
...
SaveResults='/home/baharsalafian/JBHI_LabelsForEyal_PerPatient'
SaveResultsTruePred='/home/baharsalafian/JBHI_LabelsForEyal_PerPatient'

i=0
k=None
j=256

ModelTrain(dirname,dirname2,modeldir,SaveResults,SaveResultsTruePred,'CNN_per_pataint',LR=0.0001,seq_len=1,cnn=1,smile=0,diff=0,smile_new_arch=0,twodcnn=0,spectrogram=0,indx='test',gru=0,epoch=20,l2_size=k,drop_size=i,batchSize=j)
