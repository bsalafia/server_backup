...
ModelTrain(dirname,SaveResults,SaveHisResults,'CNN3times_NoDropL2_LessDeep',seq_len=1,cnn=1,smile=0,diff=0,twodcnn=0,epoch=350,l2_size=k,drop_size=i,batchSize=j)
