...
for trainindx, testindx in kfold.split(range(24)):
  ...
  score.append(acc)
  loss1.append(loss)
  model.save('/home/baharsalafian/CNNSMILEGRURes3times/CNNSMILEweighted3times'+ str(fold_no)+'.h5')
  fold_no=fold_no+1
...
np.save(os.path.join(SaveResults,'accuracyCNNSMILEweighted3times'),score)
np.save(os.path.join(SaveResults,'lossCNNSMILEweighted3times'),loss1)
