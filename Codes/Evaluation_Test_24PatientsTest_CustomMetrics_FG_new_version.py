...
def ModelTrain(dirname,dirname2,dirprobs,modeldir,SaveResults,SaveResultsTruePred,nameProbPrefix,modelname,seq_len,cnn,smile,diff,twodcnn,spectrogram,cnnsmilespect,indx,gru,epoch,l2_size,drop_size,batchSize,noise):
  ...
  savenamef1='fscore_new_version_'+modelname+'_'+indx+'_'+'epoch_'+str(epoch)+'_batchsize_'+str(batchSize)
  ...
  #   np.save(os.path.join(SaveResults, precname),prec)
    ...
    np.save(os.path.join(SaveResults, savenamef1+'_'+str(th)),  fscore_final)
...
dirprobs='/home/baharsalafian/JBHI_FG_AllPatient_Results'
i=0
k=None
j=256
# n=0
ModelTrain(dirname,dirname2,dirprobs,modeldir,SaveResults,SaveResultsTruePred,'JBHI_all_patients_train_CNNsmile','MICAL_24Testfiles_init_0.0001',seq_len=1,cnn=0,smile=1,diff=0,twodcnn=0,spectrogram=0,cnnsmilespect=0,indx='test',gru=0,epoch=100,l2_size=k,drop_size=i,batchSize=j,noise=0)
