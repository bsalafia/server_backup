...
def ModelTrain(dirname,SaveResults,SaveLabels,indx,modelname,batchsize,epoch,cnn,smile,diff,seq_len):
  ...
  for trainindx, testindx in kfold.split(range(24)):
    ...
    fold_no=fold_no+1
    # print(testindx)
    ytest,ypred,model=ReadMatFiles(dirname,SaveResults,indx,trainindx, fold_no,modelname,batchsize,epoch ,cnn,smile,diff,seq_len)
    ...
    # model.save(SaveLabels+'/'+modelname+str(fold_no)+'.h5')
  #   print(len(ypred))
...
# seq_len=7
ModelTrain(dirname,SaveResults,SaveLabels,'train_finetune_medium','CNNGRU10times',batchsize=256,epoch=4,cnn=1,smile=0,diff=0,seq_len=3)
