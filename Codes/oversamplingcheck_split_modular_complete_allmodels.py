# -*- coding: utf-8 -*-
"""OverSamplingCheck_Split_modular_complete_Allmodels.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/15WT2ssVB0EWdCVjP-xM5LJs_4i1hspXJ
"""
...
def test_on_batch(model,X_test,mitest,y_test,spectrogram_test,batch_size,cnn,smile,spectrogram,cnnsmilespec,twodcnn,diff):
  ...
  mi_batch=mitest
  y_batch = y_test
  spectrogram_batch = spectrogram_test
  # X_test=Make_X(cnn,smile,spectrogram,cnnsmilespec,twodcnn,diff,x_batch,mi_batch,spectrogram_batch)
  y_pred=Make_X(model,cnn,smile,spectrogram,cnnsmilespec,twodcnn,diff,x_batch,mi_batch,spectrogram_batch,test=1)
  loss_val=loss_fn(y_batch, y_pred)
  val_loss_avg.update_state(loss_val)
...
def Select_Model(cnn,smile,spectrogram,cnnsmilespec,twodcnn,diff,l2_size,drop_size):
...
ModelResults='/home/baharsalafian/Custom_model_test'

modelname='Spectrogram_24Testfiles'
initLR=0.001
cnn=0
smile=1
spectrogram=0
...
for i in range(2):
  ...
  lr=optimizer.learning_rate
  tf.keras.backend.clear_session()
  model=Select_Model(cnn,smile,spectrogram,cnnsmilespec,twodcnn,diff,l2_size,drop_size)
  model,history=Get_results(model,num_epochs,X_train, y_train, mi,spec_train,X_test, y_test, mitest,spec_test,batch_size,mini_batch,cnn,smile,spectrogram,cnnsmilespec,twodcnn,diff)
  model.save(ModelResults+'/'+modelname+'_initLR_'+str(initLR)+'_fold'+str(i+1)+'_epoch_'+str(num_epochs)+'_batchsize_'+str(batch_size)+'.h5')
...
# SaveHisResults='/home/baharsalafian/Custom_train_test'
# ModelResults='/home/baharsalafian/Custom_model_test'
# Model_train(dirname,dirname2,ModelResults,SaveHisResults,modelname='Spectrogram_24Testfiles',initLR=0.01,cnn=0,smile=0,spectrogram=1,cnnsmilespec=0,twodcnn=0,diff=0,num_epochs=2,batch_size=256,SeqLen=1,l2_size=None,drop_size=0)
