...
np.save(os.path.join(SaveResults, 'fpr_cnn3timesGRUtrain'),  fpr)
np.save(os.path.join(SaveResults, 'tpr_cnn3timesGRUtrain'),  tpr)
np.save(os.path.join(SaveResults, 'PR_cnn3timesGRUtrain'), PR)
np.save(os.path.join(SaveResults, 'ROC_cnn3timesGRUtrain'),  ROC)
