...
Original file is located at
    https://colab.research.google.com/drive/13hppXHNxRozf8qkVQNDQHjjSVd5I2Pwf
"""
  ...
  for l in labels:
    for j in range(X_train.shape[2]-1):
      for k in range(j+1, X_train.shape[2]):
        ...
        savemat(os.path.join(dir_mi_results , 'MI_NewEst'+'_dim'+str(critic_params['dim'])+'_AllChan_fileidx_{}.mat'.format(file_idex)), {"estimated_MI": estimated_MI})
...
# dir_mi_results = '/content/drive/MyDrive/Colab Notebooks/Bahareh/TestSmile/'
...
#         # savemat(file_name, {"estimated_MI": estimated_MI})
#         # plt.plot(all_x.flatten())
#         # plt.plot(all_y.flatten()+1.5)
#         # plt.show()
#         # print("-----File_idx {}, Label {}, Chan1 {},  Chan2 {}, Estimated MI {:.4f}".format
