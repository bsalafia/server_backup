...
#
  ...
  model.fit([X_train,mi_train],ytrain,validation_split=0.2,batch_size=batchsize , epochs=epoch,class_weight=class_weight,verbose = 2)
  ...
  score.append(acc)
  loss1.append(loss)
  model.save('/home/baharsalafian/CNNSMILEGRURes/CNNSMILEweighted'+ str(fold_no)+'.h5')
  fold_no=fold_no+1
...
np.save(os.path.join(SaveResults,'accuracyCNNSMILEweighted'),score)
np.save(os.path.join(SaveResults,'lossCNNSMILEweighted'),loss1)
