...
def define_CNN(l2_size,drop_size):
  ...
  denseout = Dense(denseSize, activation='relu')(flat)
  denseout2 = Dense(50, activation='relu')(denseout)
  drop2=Dropout(0.5)(denseout2)
  output = Dense(1, activation='sigmoid')(drop2)
  # define a model with a list of two inputs
...
def ReadMatFiles(dirname,dirname2,ind, seq_len=1,diff=None):
  ...
  for k in range(len(ind)):
    ...
    # if Spectrogram.shape[0] != y.shape[0]:
...
def ModelTrain(dirname,dirname2,SaveResults,SaveHisResults,modelname,seq_len,cnn,smile,diff,twodcnn,spectrogram,gru,epoch,l2_size,drop_size,batchSize):
...
k=None
j=256
dirname2='/home/baharsalafian/AllMatFiles'
dirname='/home/baharsalafian/6FoldCrossSMILE'
SaveResults='/home/baharsalafian/CNNSMILEGRUModels_24TestFiles_JBHI'
SaveHisResults='/home/baharsalafian/History_24TestFiles_JBHI'

ModelTrain(dirname,dirname2,SaveResults,SaveHisResults,'CNNGRU10times_24TestFiles',seq_len=1,cnn=0,smile=0,diff=0,twodcnn=0,spectrogram=1,gru=0,epoch=100,l2_size=k,drop_size=i,batchSize=j)
