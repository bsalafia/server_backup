...
np.save(os.path.join(SaveResults, 'fpr_cnn3timesweighted'),  fpr)
np.save(os.path.join(SaveResults, 'tpr_cnn3timesweighted'),  tpr)
np.save(os.path.join(SaveResults, 'PR_cnn3timesweighted'), PR)
np.save(os.path.join(SaveResults, 'ROC_cnn3timesweighted'),  ROC)
