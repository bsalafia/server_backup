...
#
  ...
  score.append(acc)
  loss1.append(loss)
  model.save('/home/baharsalafian/CNNSMILEGRURes3times/CNN3times'+ str(fold_no)+'.h5')
  fold_no=fold_no+1
...
np.save(os.path.join(SaveResults,'accuracyCNN3times'),score)
np.save(os.path.join(SaveResults,'lossCNN3times'),loss1)
