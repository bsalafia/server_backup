...
def Make_X(x,mi,spectrogram,cnn,smile,spect,cnnsmilespec,cnngru,cnnsmilegru,twodcnn):
...
def make_batches(x_one,x_zero,y_one,y_zero,mi_one,mi_zero,spectrogram_one,spectrogram_zero,mini_batch,cnn,smile,spect,cnnsmilespec,twodcnn):
  ...
  X_main=Make_X( x_batch,mi_batch,spectrogram_batch,cnn,smile,spect,cnnsmilespec,cnngru,cnnsmilegru,twodcnn)
...
def validation_batches(x,y,mi,spectrogram,batch_size,cnn,smile,spect,cnnsmilespec,twodcnn):
  ...
  X_main=Make_X(x_one_batch,mi_one_batch,spectrogram_one_batch,cnn,smile,spect,cnnsmilespec,cnngru,cnnsmilegru,twodcnn)
...
def Select_Model(cnn,smile,spectrogram,cnnsmilespec,cnngru,cnnsmilegru,twodcnn,diff,drop_size,initLR):
...
SaveHisResults='/home/baharsalafian/LastExperiment_results_per_pataint'
ModelResults='/home/baharsalafian/LastExperiment_model_per_pataint'


modelname='CNNGRU_per_pataint_20Epoch'
initLR=0.0001
cnn=0
smile=0
spectrogram=0
...
for trainindx in range(24):
  ...
  tf.keras.backend.clear_session()
  model=Select_Model(cnn,smile,spectrogram,cnnsmilespec,cnngru,cnnsmilegru,twodcnn,diff,drop_size,initLR)
  ...
  wandb.init(project=modelname+"LR"+str(initLR), entity="bsalafian")
