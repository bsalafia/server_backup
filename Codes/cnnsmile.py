...
#     # print(sample_weight)
#
#     history=model.fit(X_train, y, validation_split=0, batch_size=batchsize, epochs=epoch, class_weight=class_weights, verbose = 2)
#     #
#     X_train = None
#     Y_train = None
#     gc.collect()
...
#
#     model.save(SaveResults+'/'+modelname+'_fold'+str(fold_no)+'_epoch_'+str(epoch)+'_batchsize_'+str(batchsize)+'.h5')
#
#     # print(history)
