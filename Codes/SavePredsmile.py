...
def ReadMatFilessmile(dirname,model,indx):
...
FoldNum=6
model1='CNNSMILE6fold3timesweighted'
...
for trainindx, testindx in kfold.split(range(24)):
  ...
  Y_test,ypred= ReadMatFilessmile(dirname,model,testindx)
