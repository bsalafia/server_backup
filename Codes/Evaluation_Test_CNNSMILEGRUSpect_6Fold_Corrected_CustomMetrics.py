...
ModelTrain(dirname,dirname2,modeldir,SaveResults,SaveResultsTruePred,'CNNSMILEGRU_AddDrop_6Fold',seq_len=3,cnn=0,spect1=0,smile=1,diff=0,twodcnn=0,cnnsmilespect=0,smile_new_arch=0,indx='test',gru=1,Noepoch=35,batch_size=256)
