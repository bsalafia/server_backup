...
#
  X_train,Y_train = ReadMatFiles(dirname1,dirname2,trainindx)

  X_test,Y_test = ReadMatFiles(dirname1,dirname2,testindx)
  ...
  score.append(acc)
  loss1.append(loss)
  model.save('/home/baharsalafian/CNNSMILE6FoldRes/CNN6foldsmileonlyV2'+ str(fold_no)+'.h5')
  fold_no=fold_no+1
...
np.save(os.path.join(SaveResults,'accuracyCNN6foldsmileonlyV2'),score)
np.save(os.path.join(SaveResults,'lossCNN6foldsmileonlyV2'),loss1)
