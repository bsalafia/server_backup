...
#
  ...
  score.append(acc)
  loss1.append(loss)
  model.save('/home/baharsalafian/CNNSMILEGRURes3times/CNNSMILE'+ str(fold_no)+'.h5')
  fold_no=fold_no+1
...
np.save(os.path.join(SaveResults,'accuracyCNNSMILE'),score)
np.save(os.path.join(SaveResults,'lossCNNSMILE'),loss1)
