...
################################################################
  ...
  denseout2 = Dense(50, activation='relu')(denseout)
...
def Select_Model(initLR,cnn,smile,spectrogram,cnnsmilespec,smile_new_arch,smile_spec_new_arch,twodcnn,diff,l2size,dropsize,stddev):
...
modelname='CNN_SMILE_MoreDense_WithAct_24Testfiles_init_0.0001'
initLR=0.0001
cnn=0
smile_new_arch=0
spectrogram=0
...
for i in range(2):
  ...
  tf.keras.backend.clear_session()
  model=Select_Model(initLR,cnn,smile,spectrogram,cnnsmilespec,smile_new_arch,smile_spec_new_arch,twodcnn,diff,l2size,dropsize,stddev)
