...
SaveResults='/home/baharsalafian/CNNSMILEAllRes'
model1dir='/home/baharsalafian/CNNSMILEResults'
model2dir='/home/baharsalafian/CNNResults'
...
# print(len(trian_index))
  ...
  ModelName1='CNNSMILELOO'+ str(fold_no)+'.h5'
  model1=tf.keras.models.load_model(os.path.join(model1dir,ModelName1))

  ModelName2='CNNLOO'+ str(fold_no)+'.h5'
  model2=tf.keras.models.load_model(os.path.join(model2dir,ModelName2))
  # X_train = None
  # Y_train = None
  # gc.collect()

  _,_,_,y_test_thresh1,_,pred_prob1 =TestDataLoad(model1,[X_test,mi_test],Y_test,threshold)
  _,_,_,y_test_thresh2,_,pred_prob2=TestDataLoad(model2,X_test,Y_test,threshold)

  precision1, recall1, _ = precision_recall_curve(y_test_thresh1, pred_prob1)
  AUC_PR_smile.append(auc(recall1, precision1))
  AUC_ROC_smile.append(roc_auc_score(y_test_thresh1, pred_prob1))

  precision2, recall2, _ = precision_recall_curve(y_test_thresh2, pred_prob2)
  AUC_PR_cnn.append(auc(recall2, precision2))
  AUC_ROC_cnn.append(roc_auc_score(y_test_thresh2, pred_prob2))

  print('AUC_PR_smile: ',AUC_PR_smile[i])
  print('AUC_PR_cnn: ',AUC_PR_cnn[i])
  # model.save('/home/baharsalafian/CNNSMILEResults/CNNSMILELOO'+ str(fold_no)+'.h5')
  fold_no=fold_no+1
...
np.save(os.path.join(saveresults, 'AUC_ROC_smile'), AUC_ROC_smile)
np.save(os.path.join(saveresults, 'AUC_PR_smile'), AUC_PR_smile)

np.save(os.path.join(saveresults, 'AUC_ROC_cnn'), AUC_ROC_cnn)
np.save(os.path.join(saveresults, 'AUC_PR_cnn'), AUC_PR_cnn)
