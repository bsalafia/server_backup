...
def ReadMatFiles(dirname,SaveResults,indx,fold_no,modelname,batchsize,epoch ,cnn,smile,diff,seq_len):
...
def ModelTrain(dirname,SaveResults,SaveLabels,modeldir,indx,modelname,batchsize,epoch,cnn,smile,diff,seq_len):
  ...
  for th in [0.3,0.4,0.5,0.6,0.7]:
    ...
    for trainindx, testindx in kfold.split(range(24)):
      ...
      ytest,ypred,model=ReadMatFiles(dirname,modeldir,trainindx, fold_no,modelname,batchsize,epoch ,cnn,smile,diff,seq_len)
      print(len(ypred))
...
# seq_len=7
ModelTrain(dirname,SaveResults,SaveLabels,modeldir,'train_finetune_medium_Noweight','CNNSMILEDiffGRUNoweight',batchsize=256,epoch=3,cnn=0,smile=0,diff=1,seq_len=3)
