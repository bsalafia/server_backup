# -*- coding: utf-8 -*-
"""SMILE_Bahareh_PerChannel_server.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1SJTA2x-ulkLxVUF0XbHMAhANszRmRVpr
"""
...
def SavePatientswithEDFList(dirnameAllMats,savedir,WindowSize,indx):
  ...
  Data.Xfile=Xfile
  Data.Yfile=Yfile
  savemat(os.path.join(savedir, Name[indx]+'_'+str(WindowSize)+'.mat'), {'Data':Data})
  return Xfile,Yfile
...
savedir='/home/baharsalafian/SMILEOldVersion'
...
#######SMILEstimation#####################
  ...
  #. Initialize the Netral Network
          ...
          savemat(os.path.join(savedir, 'MI_Est_PerChan_fileidx_{}.mat'.format(file_idex)), {"estimated_MI": estimated_MI})
          # plt
          # plt.plot(all_x.flatten())
          # plt.plot(all_y.flatten()+1.5)
          # plt.show()
