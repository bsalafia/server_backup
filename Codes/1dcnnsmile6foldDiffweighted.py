...
#
  ...
  class_weight = {0:1.,
                  1:20.}
  model.fit([X_train,mi_train,midiff_train],ytrain,validation_split=0.2,batch_size=batchsize , epochs=epoch,class_weight=class_weight,verbose = 2)
  ...
  score.append(acc)
  loss1.append(loss)
  model.save('/home/baharsalafian/EyalRes/CNNSMILEDiff6fold10timesweighted'+ str(fold_no)+'.h5')
  fold_no=fold_no+1
...
np.save(os.path.join(SaveResults,'accuracyCNNSMILEDiff6fold10timesweighted'),score)
np.save(os.path.join(SaveResults,'lossCNNSMILEDiff6fold10timesweighted'),loss1)
