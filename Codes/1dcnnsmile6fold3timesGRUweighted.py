...
for trainindx, testindx in kfold.split(range(24)):
  ...
  model.fit([X_train,mi_train],ytrain,validation_split=0.2,batch_size=batchsize , epochs=epoch,class_weight=class_weights,verbose = 2)
  ...
  score.append(acc)
  loss1.append(loss)
  model.save('/home/baharsalafian/GRURes/CNNSMILEGRU3timesweighted'+ str(fold_no)+'.h5')
  fold_no=fold_no+1
...
np.save(os.path.join(SaveResults,'accuracyCNNSMILEGRU3timesweighte'),score)
np.save(os.path.join(SaveResults,'lossCNNSMILEGRU3timesweighted'),loss1)
