...
np.save(os.path.join(SaveResults, 'fpr_cnnpre'),  fpr_cnn)
np.save(os.path.join(SaveResults, 'tpr_cnnpre'), tpr_cnn)
np.save(os.path.join(SaveResults, 'PR_cnnpre'), PR_cnn)
np.save(os.path.join(SaveResults, 'ROC_cnnpre'), ROC_cnn)
