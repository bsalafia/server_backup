...
np.save(os.path.join(SaveResults, 'fpr_cnn10timesGRUtrain'),  fpr)
np.save(os.path.join(SaveResults, 'tpr_cnn10timesGRUtrain'),  tpr)
np.save(os.path.join(SaveResults, 'PR_cnn10timesGRUtrain'), PR)
np.save(os.path.join(SaveResults, 'ROC_cnn10timesGRUtrain'),  ROC)
