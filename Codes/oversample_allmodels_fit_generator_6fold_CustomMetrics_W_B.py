...
def Make_X(x,mi,spectrogram,cnn,smile,spect,cnnsmilespec,smile_new_arch,eeg_smilemat,twodcnn):
...
def make_batches(x_one,x_zero,y_one,y_zero,mi_one,mi_zero,spectrogram_one,spectrogram_zero,mini_batch,cnn,smile,spect,cnnsmilespec,smile_new_arch,twodcnn):
  ...
  X_main=Make_X( x_batch,mi_batch,spectrogram_batch,cnn,smile,spect,cnnsmilespec,smile_new_arch,eeg_smilemat,twodcnn)
...
def validation_batches(x,y,mi,spectrogram,batch_size,cnn,smile,spect,cnnsmilespec,twodcnn):
  ...
  X_main=Make_X(x_one_batch,mi_one_batch,spectrogram_one_batch,cnn,smile,spect,cnnsmilespec,smile_new_arch,eeg_smilemat,twodcnn)
...
def Select_Model(cnn,smile,spectrogram,cnnsmilespec,smile_new_arch,eeg_smilemat,twodcnn,diff,l2size,dropsize,stddev,initLR):
  ...
  if smile==1:
    tf.keras.backend.clear_session()
    model=define_SMILE(dropsize,initLR)
...
for trainindx, testindx in kfold.split(range(24)):
  ...
  tf.keras.backend.clear_session()
  model=Select_Model(cnn,smile,spectrogram,cnnsmilespec,smile_new_arch,eeg_smilemat,twodcnn,diff,l2size,dropsize,stddev,initLR)
