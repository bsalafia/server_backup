...
for trainindx, testindx in kfold.split(range(24)):
  ...
  ypredNoth=model1.predict(X_test)
  # d = (ypred1 > th).astype(int)
  # precision, recall, f1, _ = precision_recall_fscore_support(ytest, ypred, average='weighted')
  fpr1, tpr1, _ = roc_curve(ytest, ypredNoth)
  precision, recall, _ = precision_recall_curve(ytest, ypredNoth)
  PR1=auc(recall, precision)
  ROC1=roc_auc_score(ytest,ypredNoth)
  fpr.append(fpr1)
  tpr.append(tpr1)
  PR.append(PR1)
  ROC.append(ROC1)
...
np.save(os.path.join(SaveResults, 'fpr_cnn10timesweightedtrain'),  fpr)
np.save(os.path.join(SaveResults, 'tpr_cnn10timesweightedtrain'),  tpr)
np.save(os.path.join(SaveResults, 'PR_cnn10timesweightedtrain'), PR)
np.save(os.path.join(SaveResults, 'ROC_cnn10timesweightedtrain'),  ROC)
