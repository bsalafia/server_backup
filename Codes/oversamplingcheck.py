# -*- coding: utf-8 -*-
"""Copy of OverSamplingCheck.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1zYd1uqep3iD00Xb1zm0hyFm5PEr2qO4n
"""
...
# batch_size=64
  ...
  for epoch in range(0, num_epochs):
    ...
    for i in range(0, len(X_train) // batch_size):
        ...
        mi_batch= mi[i * batch_size:min(len(mi), (i+1) * batch_size)]
        # print(X.shape)
    ...
    print(f"Accuracy over epoch {train_acc}, ROC= {train_roc}, PR= {train_pr} , Precision={train_precision}, Recall={train_recall}, f1score={train_f1score} ")
    ...
    train_recall=recall_metric.result()
    train_f1score=2*(train_precision*train_recall)/(train_precision+train_recall)
    print(f"Accuracy over epoch {test_acc}, ROC= {train_roc}, PR= {train_pr} , Precision={train_precision}, Recall={train_recall}, f1score={train_f1score} ")
    acc_metric.reset_states()
    roc_metric.reset_state()
    pr_metric.reset_state()
    precision_metric.reset_state()
    ...
    # acc_metric.reset_states()
  # define_SMILE(l2_size=None,drop_size=0)
