...
modeldir='/home/baharsalafian/CustomMetrics_model_fit_generator_Allcase'

SaveResults='/home/baharsalafian/Results_24TestFiles_JBHI_CustomMetrics_Oversample'
SaveResultsTruePred='/home/baharsalafian/TruePredPlots_24TestFiles_JBHI_CustomMetrics_Oversample'
i=0
k=None
j=256

ModelTrain(dirname,dirname2,modeldir,SaveResults,SaveResultsTruePred,'CNNSMILE_24Testfiles_init_0.0001',seq_len=1,cnn=0,smile=1,diff=0,twodcnn=0,spectrogram=0,cnnsmilespect=0,indx='test',gru=0,epoch=100,l2_size=k,drop_size=i,batchSize=j)
