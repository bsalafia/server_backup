...
model=define_model()
FoldNum=6
X_test,Y_test,mi_test = ReadMatFiles(dirname,[0])
...
#   score.append(acc)
#   loss1.append(loss)
#   model.save('/home/baharsalafian/CNNSMILE6FoldRes/CNNSMILE6fold'+ str(fold_no)+'.h5')
#   fold_no=fold_no+1
...
#   gc.collect()
#
# np.save(os.path.join(SaveResults,'accuracyCNNSMILE6fold'),score)
# np.save(os.path.join(SaveResults,'lossCNNSMILE6fold'),loss1)
#
