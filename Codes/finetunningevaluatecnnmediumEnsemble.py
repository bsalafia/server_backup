...
def ModelTrain(dirname,SaveResults,indx,modelname,batchsize,epoch):
  ...
  for th in [0.5,0.7]:
    ...
    for trainindx, testindx in kfold.split(range(24)):
      ...
      ytest_cnn,ypred_cnn=ReadMatFiles(dirname,SaveResults,indx,testindx, fold_no,modelnamecnn,batchsize,epoch ,cnn=1,smile=0,diff=0,seq_len=1,twodcnn=0)
      ytest_smile,ypred_smile=ReadMatFiles(dirname,SaveResults,indx,testindx, fold_no,modelnamesmile,batchsize,epoch ,cnn=0,smile=1,diff=0,seq_len=1,twodcnn=0)
      ytest_diff,ypred_diff=ReadMatFiles(dirname,SaveResults,indx,testindx, fold_no,modelnamediff,batchsize,epoch ,cnn=0,smile=0,diff=1,seq_len=1,twodcnn=0)
...
# seq_len=7
ModelTrain(dirname,SaveResults,'test_finetune_medium','EnsembleModelCNN',batchsize=256,epoch=4)
