...
###########################################
  ...
  np.savez(os.path.join(SaveHisResults, 'HistoryRes_'+modelname+'_epoch_'+str(epoch+epochLoad)), loss=loss, loss_val=loss_val, accuracy=acc, accuracy_val=acc_val,LR=LR)
  plt.plot(acc_mean)
...
ModelTrain(dirname,dirname2,SaveResults,SaveHisResults,modeldir,'CNN_Spectogram10times_Decay.5_lr.001','CNN_Spectogram10times_lr.00001',batchsize=256,epoch=150,epochLoad=0)
