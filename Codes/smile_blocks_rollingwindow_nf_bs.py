# -*- coding: utf-8 -*-
"""SMILE_Blocks_RollingWindow_NF_BS.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1vx75U0fvAn05g4iKl_o7vZp8VwGW8JFP
"""
...
dirname='/home/baharsalafian/SMILEP2Data'
savedir='/home/baharsalafian/SMILETests/'
...
for q in range(len(WindowSize)):
  for file_idx in range(len(EDFFiles)):
    ...
    X_train,Y_train=Label(dirname,EDFFiles[file_idx],WindowSize[q])
    ...
    for i in range(X_train.shape[0]):
      ...
      savemat(os.path.join(savedir, Name[0]+'MI_RollWindow'+str(WindowSize[0])+'_NNdim'+str(critic_params['NNdim'])+'_fileidx_{}_MaxEpoch{}_MinEpoch{}.mat'.format(file_idx,init_epoch,rest_epoch)), {"estimated_MI": estimated_MI, "Y_label": Y_train})
      print("-----File_idx {}, indx {}, label {}".format(file_idx, i, Y_train[i]))
