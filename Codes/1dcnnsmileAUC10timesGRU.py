...
np.save(os.path.join(SaveResults, 'fpr_cnnsmile10timesGRUtrain'),  fpr)
np.save(os.path.join(SaveResults, 'tpr_cnnsmile10timesGRUtrain'),  tpr)
np.save(os.path.join(SaveResults, 'PR_cnnsmile10timesGRUtrain'), PR)
np.save(os.path.join(SaveResults, 'ROC_cnnsmile10timesGRUtrain'),  ROC)
