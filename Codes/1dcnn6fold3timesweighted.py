...
for trainindx, testindx in kfold.split(range(24)):
  ...
  score.append(acc)
  loss1.append(loss)
  model.save('/home/baharsalafian/CNNSMILEGRURes3times/CNNweighted3times'+ str(fold_no)+'.h5')
  fold_no=fold_no+1
...
np.save(os.path.join(SaveResults,'accuracyCNNweighted3times'),score)
np.save(os.path.join(SaveResults,'lossCNNsweighted3times'),loss1)
