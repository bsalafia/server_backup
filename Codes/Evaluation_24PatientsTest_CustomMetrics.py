...
j=256
# n=0
ModelTrain(dirname,dirname2,modeldir,SaveResults,SaveResultsTruePred,'CNN_SMILE_MoreDense_24Testfiles_init_0.0001',seq_len=1,cnn=0,smile=1,diff=0,twodcnn=0,spectrogram=0,cnnsmilespect=0,indx='test',gru=0,epoch=100,l2_size=k,drop_size=i,batchSize=j,noise=0)
