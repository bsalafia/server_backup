# -*- coding: utf-8 -*-
"""OverSamplingCheck_Split_modular.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1nRYr5Nk46MuvsnSvAnrdKelb0d6NshGD
"""
...
# batch_size=64
  ...
  for epoch in range(0, num_epochs):
    ...
    train_loss=[]
    test_loss=[]
    train_on_batch(X_train, y_train, mi,spec_train,batch_size,mini_batch)
    test_on_batch(X_test,mitest,y_test,batch_size)
    lr=optimizer.learning_rate
