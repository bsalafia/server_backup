...
#
  ...
  score.append(acc)
  loss1.append(loss)
  model.save('/home/baharsalafian/GRURes/CNNSMILEDiffGRU10times'+ str(fold_no)+'.h5')
  fold_no=fold_no+1
...
np.save(os.path.join(SaveResults,'accuracyCNNSMILEDiffGRU10times'),score)
np.save(os.path.join(SaveResults,'lossCNNSMILEDiffGRU10times'),loss1)
