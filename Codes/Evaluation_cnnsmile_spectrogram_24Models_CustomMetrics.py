...
def Xtrain(cnn,smile,diff,smile_new_arch,twodcnn,spectrogram,cnngru,cnnsmilegru,x,y,mi,spec):
...
def ModelTrain(dirname,dirname2,modeldir,SaveResults,SaveResultsTruePred,modelname,LR,seq_len,cnn,smile,diff,smile_new_arch,twodcnn,cnngru,cnnsmilegru,spectrogram,indx,gru,epoch,l2_size,drop_size,batchSize):
  ...
  for th in [0.7]:
    ...
    for testindx in range(24):
      ...
      X_train=Xtrain(cnn,smile,diff,smile_new_arch,twodcnn,spectrogram,cnngru,cnnsmilegru,Xtest,Ytest,MItest,Spectest)
...
ModelTrain(dirname,dirname2,modeldir,SaveResults,SaveResultsTruePred,'Spectrogram_per_pataint',LR=0.0001,seq_len=1,cnn=0,smile=0,diff=0,smile_new_arch=0,twodcnn=0,cnngru=0,cnnsmilegru=0,spectrogram=1,indx='test',gru=0,epoch=20,l2_size=k,drop_size=i,batchSize=j)
