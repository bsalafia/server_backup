...
#
  ...
  score.append(acc)
  loss1.append(loss)
  model.save('/home/baharsalafian/CNNSMILEGRURes3times/CNNSMILEDiffweighted3times'+ str(fold_no)+'.h5')
  fold_no=fold_no+1
...
np.save(os.path.join(SaveResults,'accuracyCNNSMILEDiffweighted3times'),score)
np.save(os.path.join(SaveResults,'lossCNNSMILEDiffweighted3times'),loss1)
