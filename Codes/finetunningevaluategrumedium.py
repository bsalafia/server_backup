...
def ModelTrain(dirname,SaveResults,indx,modelname,batchsize,epoch,cnn,smile,diff,seq_len):
  ...
  for trainindx, testindx in kfold.split(range(24)):
    ...
    fold_no=fold_no+1
    # print(testindx)
    ytest,ypred=ReadMatFiles(dirname,SaveResults,indx,trainindx, fold_no,modelname,batchsize,epoch ,cnn,smile,diff,seq_len)
    print(len(ypred))
...
# seq_len=7
ModelTrain(dirname,SaveResults,'train_finetune_medium','CNNSMILEDiffGRU10times',batchsize=256,epoch=4,cnn=0,smile=0,diff=1,seq_len=3)
