# -*- coding: utf-8 -*-
"""OverSamplingCheck_Split_modular_complete.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1YRc7Uvu2YJgLm84p00hM_pulix1DNKGd
"""
...
def train_on_batch(X_train, y_train, mi,spec_train,batch_size,mini_batch):
  ...
  return train_loss,train_acc,train_roc,train_pr,train_precision,train_recall,train_f1score

def test_on_batch(X_test,mitest,y_test,batch_size):
...
def Get_results(num_epochs,X_train, y_train, mi,spec_train,batch_size,mini_batch):
  ...
  for epoch in range(0, num_epochs):
    ...
    train_loss=[]
    test_loss=[]
    train_loss,train_acc,train_roc,train_pr,train_precision,train_recall,train_f1score=train_on_batch(X_train, y_train, mi,spec_train,batch_size,mini_batch)
    test_loss,test_acc,test_roc,test_pr,test_precision,test_recall,test_f1score=test_on_batch(X_test,mitest,y_test,batch_size)
    print("after batch show me", test_pr)
    lr=optimizer.learning_rate
    lr_new=lr_exp_decay(epoch, lr)
...
def Plot_func(SaveHisResults,metric,metric_val,metric_name,modelname,epoch,batchSize):
  ...
  plt.title(modelname+'_'+metric_name+'_epoch_'+str(epoch)+'_batchsize_'+str(batchSize))
...
SaveHisResults='/home/baharsalafian/Custom_train_test'
loss=[]
loss_val=[]
...
for i in range(2):
  ...
  history=Get_results(num_epochs,X_train, y_train, mi,spec_train,batch_size,mini_batch)
  ...
  f1.append(history['f1_score'])
  f1_val.append(history['val_f1_score'])

  PR.append(history['auc_pr'])
  PR_val.append(history['val_auc_pr'])

  ROC.append(history['auc_roc'])
  ROC_val.append(history['val_auc_roc'])

  PR_m.append(history['precision'])
  PR_m_val.append(history['val_precision'])

  recall.append(history['recall'])
  recall_val.append(history['val_recall'])
  LR.append(history['lr'])

print("show me len od PR",loss)
print(loss_val)

Plot_func(SaveHisResults,acc,acc_val,'accuracy','test',num_epochs,batch_size)
Plot_func(SaveHisResults,loss,loss_val,'loss','test',num_epochs,batch_size)

Plot_func(SaveHisResults,f1,f1_val,'f1_score','test',num_epochs,batch_size)
Plot_func(SaveHisResults,PR,PR_val,'AUC_PR','test',num_epochs,batch_size)

Plot_func(SaveHisResults,ROC,ROC_val,'AUC_ROC','test',num_epochs,batch_size)
Plot_func(SaveHisResults,PR_m,PR_m_val,'Precision','test',num_epochs,batch_size)
Plot_func(SaveHisResults,recall,recall_val,'Recall','test',num_epochs,batch_size)
