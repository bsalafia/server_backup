...
def ModelTrain(dirname,dirname2,modeldir,SaveResults,SaveResultsTruePred,modelname,indx,gru,Noepoch,batchSize):
  ...
  for th in [0.5]:
    ...
    for trainindx, testindx in kfold.split(range(24)):
      ...
      x, y=ReadMatFiles(dirname,dirname2,ind)
  ...
  #
      ModelName1=modelname+'_fold'+str(fold_no)+'_Spectogram'+'.h5'
...
modeldir='/home/baharsalafian/SpectogramModelsSyncMI_CorrectVersion'
dirname2='/home/baharsalafian/6FoldCrossSMILE'
SaveResults='/home/baharsalafian/Results_Evaluation_Spectogram_Corrected'
SaveResultsTruePred='/home/baharsalafian/TruePredPlot_Spectogram_Corrected'

ModelTrain(dirname,dirname2,modeldir,SaveResults,SaveResultsTruePred,'CNN_Spectogram_SyncMI',indx='test',gru=0,Noepoch=100,batchSize=256)
