...
def ReadMatFiles(dirname,dirname2,indx, seq_len=1,diff=None):
  ...
  for k in range(len(ind)):
    ...
    X_final.append(X)
    Y_final.append(Y)
    MI_diff_final.append(MI_diff_all)
    MI_final.append(MI_all)
  ...
  MI_final=np.concatenate(MI_final,axis=0)
  MI_diff_final=np.concatenate(MI_diff_final,axis=0)
  Spect_final=np.concatenate(Spect_final,axis=0)
  # print("shape of input",X_final.shape)
  # time.sleep(5)
...
def ModelTrain(dirname,dirname2,dirprobs,modeldir,SaveResults,SaveResultsTruePred,nameProbPrefix,modelname,seq_len,cnn,spect1,smile,diff,twodcnn,cnnsmilespect,smile_new_arch,indx,gru,Noepoch,batch_size):
...
SaveResultsTruePred='/home/baharsalafian/TruePredPlots_6fold_JBHI_Lastexperiments'

dirprobs='/home/baharsalafian/JBHI_FG_6Fold_Results'

ModelTrain(dirname,dirname2,dirprobs,modeldir,SaveResults,SaveResultsTruePred,'JBHI_6Fold_CNN','CNNFG_6Fold',seq_len=1,cnn=1,spect1=0,smile=0,diff=0,twodcnn=0,cnnsmilespect=0,smile_new_arch=0,indx='test',gru=0,Noepoch=100,batch_size=256)
