...
np.save(os.path.join(SaveResults, 'fpr_cnnsmilediff3timesGRUtrain'),  fpr)
np.save(os.path.join(SaveResults, 'tpr_cnnsmilediff3timesGRUtrain'),  tpr)
np.save(os.path.join(SaveResults, 'PR_cnnsmilediff3timesGRUtrain'), PR)
np.save(os.path.join(SaveResults, 'ROC_cnnsmilediff3timesGRUtrain'),  ROC)
