...
def define_model_CNNGRU():
  ...
  encoded_sequence = GRU(50, return_sequences=True)(encoded_frames)
...
#
  ...
  model.fit(X_train,ytrain,validation_split=0.2,batch_size=batchsize , epochs=epoch,verbose = 2)
  ...
  score.append(acc)
  loss1.append(loss)
  model.save('/home/baharsalafian/GRURes/CNNGRU10timesNobidir'+ str(fold_no)+'.h5')
  fold_no=fold_no+1
...
np.save(os.path.join(SaveResults,'accuracyCNNGRU10times'),score)
np.save(os.path.join(SaveResults,'lossCNNGRU10times'),loss1)
