...
ModelTrain(dirname,SaveResults,SaveHisResults,modeldir,'CNNSMILE10times_Decay.5_lr.001_NoAct','CNNSMILE10times_lr.001_NoAct',seq_len=1,cnn=0,smile=1,diff=0,twodcnn=0,epoch=100, epochLoad=0,l2_size=k,drop_size=i,batchSize=j)
