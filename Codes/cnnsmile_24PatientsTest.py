...
def define_CNN(l2_size,drop_size):
  ...
  denseout2 = Dense(denseSize, activation='relu')(denseout)
  drop2=Dropout(0.5)(denseout2)
  output = Dense(1, activation='sigmoid')(drop2)
  # define a model with a list of two inputs
...
SaveResults='/home/baharsalafian/CNNSMILEGRUModels_24TestFiles_JBHI_test'
SaveHisResults='/home/baharsalafian/History_24TestFiles_JBHI_test'

ModelTrain(dirname,SaveResults,SaveHisResults,'CNNSMILE10times_NoAct',seq_len=1,cnn=0,smile=1,diff=0,twodcnn=0,epoch=100,l2_size=k,drop_size=i,batchSize=j)
