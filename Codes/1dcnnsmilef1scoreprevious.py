...
SaveResults='/home/baharsalafian/PreviousCNNRes'
...
np.save(os.path.join(SaveResults, 'f1_score_cnnpre'),  f1_score_cnn)
np.save(os.path.join(SaveResults, 'Precision_cnnpre'), Precision_cnn)
np.save(os.path.join(SaveResults, 'Recall_cnnpre'), Recall_cnn)
