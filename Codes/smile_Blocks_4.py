...
file_name='PrintOut_RollWindow'+str(WindowSize[0])+'_NNdim'+str(critic_params['NNdim'])+'_dim'+str(critic_params['dim'])+'LessEpoch_testP2.txt'
      ...
      for i in range(X_train.shape[0]):
        ...
        for j in range(X_train.shape[2]-1):
          ...
          # print(all_y.shape)
            ...
            savemat(os.path.join(savedir, 'MI_Est_RollWindow'+str(WindowSize[0])+'_NNdim'+str(critic_params['NNdim'])+'_AllChan_fileidx_LessEpochtestP_{}.mat'.format(file_idex+1)), {"estimated_MI": estimated_MI})
