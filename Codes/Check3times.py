...
#
  ...
  print(X_train.shape,Y_train.shape,mi_train.shape)
  ...
  # score.append(acc)
  # loss1.append(loss)
  # model.save('/home/baharsalafian/CNNSMILE6FoldRes/CNNSMILE6foldV2'+ str(fold_no)+'.h5')
  # fold_no=fold_no+1
...
# np.save(os.path.join(SaveResults,'accuracyCNNSMILE6foldV2'),score)
# np.save(os.path.join(SaveResults,'lossCNNSMILE6foldV2'),loss1)
