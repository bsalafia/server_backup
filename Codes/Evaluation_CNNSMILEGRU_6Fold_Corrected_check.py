...
def ModelTrain(dirname,modeldir,SaveResults,SaveResultsTruePred,modelname,seq_len,cnn,smile,diff,twodcnn,indx,gru,Noepoch):
  ...
  for th in [0.5]:
    ...
    for trainindx, testindx in kfold.split(range(24)):
      ...
      x, y, mi,mi_diff,_,_,_,_=ReadMatFiles(dirname,ind,seq_len,diff)

      print('for test length', len(x))

      fold_no=fold_no+1

      ModelName1=modelname+ '_fold'+str(fold_no)+'_epoch_'+str(Noepoch)+'_l2Size_None_DropSize_0_batchsize_256'+'.h5'
  ...
  #       ind=trainindx
  #     fold_no=fold_no+1
  #     _,_,_,_,x, y, mi,mi_diff=ReadMatFiles(dirname,ind,seq_len,diff)
...
modeldir='/home/baharsalafian/CNNSMILEGRUModels_JBHI_6FoldLRTest'

SaveResults='/home/baharsalafian/Results_JBHI_6FoldLRTest'

SaveResultsTruePred='/home/baharsalafian/TruePredPlots_JBHI_6FoldLRTest'

ModelTrain(dirname,modeldir,SaveResults,SaveResultsTruePred,'CNNSMILE10times_Decay.5_lr.001_NoAct',seq_len=1,cnn=0,smile=1,diff=0,twodcnn=0,indx='test',gru=0,Noepoch=150)
