...
savename='fscore_cnnsmilediffGRU10timestrain'
threshold=0.2
...
for th in [0.3,0.4,0.5,0.6,0.7,0.8,0.9]:
  ...
  for trainindx, testindx in kfold.split(range(24)):
      ...
      ypred=model1.predict([X_test,mi_test,midiff])
      ypred = (ypred > th).astype(int)
      ...
      fold_no=fold_no+1
  np.save(os.path.join(SaveResults, savename+str(th)),  fscore)
