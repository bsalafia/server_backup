...
SaveResults='/home/baharsalafian/10timestestdata'
...
FoldNum=6
model='CNNSMILE6fold10timesweighted'
savename='cnfmat_cnnsmile10timesweighted'
threshold=0.2
...
for trainindx, testindx in kfold.split(range(24)):
  ...
  np.save(os.path.join(SaveResults, 'mi_test_'+str(fold_no)), mi_test)
  fold_no=fold_no+1
