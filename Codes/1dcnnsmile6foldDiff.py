...
#
  ...
  score.append(acc)
  loss1.append(loss)
  model.save('/home/baharsalafian/CNNSMILE6FoldRes/CNNSMILE6foldDiffV2'+ str(fold_no)+'.h5')
  fold_no=fold_no+1
...
np.save(os.path.join(SaveResults,'accuracyCNNSMILE6foldDiffV2'),score)
np.save(os.path.join(SaveResults,'lossCNNSMILE6foldDiffV2'),loss1)
