...
def data_generator_check(data_main,batch_size,n_chan,tcn,cnn,two_dcnn,gru,len_seq,len_seq_gru):  
  ...
  print("this is train shape for zeros", x_zero.shape[0])
  print("this is train shape for ones", x_one.shape[0])
...
#print(train_steps)
print(names_test)
#data_generator_check(names_train,batch_size,num_channel,tcn,cnn,two_dcnn,gru,len_seq,len_seq_gru)
