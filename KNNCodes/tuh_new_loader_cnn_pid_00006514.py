...
if not os.path.exists(os.path.join(dir_csv,'data_files_tuh_selected_gru')):
    os.mkdir(os.path.join(dir_csv,'data_files_tuh_selected_gru'))

if not os.path.exists(os.path.join(dir_csv,'data_files_tuh_selected_gru/train')):
    os.mkdir(os.path.join(dir_csv,'data_files_tuh_selected_gru/train'))

if not os.path.exists(os.path.join(dir_csv,'data_files_tuh_selected_gru/test')):
    os.mkdir(os.path.join(dir_csv,'data_files_tuh_selected_gru/test'))

if not os.path.exists(os.path.join(dir_csv,'data_files_tuh_selected_gru/valid')):
    os.mkdir(os.path.join(dir_csv,'data_files_tuh_selected_gru/valid'))



dirname='/home/baharsalafian/TUH_Bahareh_experiment/v1.5.2/raw_seizures'

all_img_dir = '/home/baharsalafian/tuh_all_images_selected_gru'
...
modelname = 'GRU_tuh_pid_00006514_no_oversample'
initLR = 0.0001
num_epochs = 50
batch_size = 256
...
df_train = pd.read_pickle(os.path.join(os.path.join(dir_csv,'data_files_tuh_selected_gru/train'), 'train.pkl'))
...
df_test = pd.read_pickle(os.path.join(os.path.join(dir_csv,'data_files_tuh_selected_gru/valid'), 'valid.pkl'))
