...
df_test = pd.read_pickle(os.path.join(os.path.join(dir_csv,'data_files_tuh/test'), 'test.pkl'))
...
wandb.init(project = modelname+'_batch_size_'+str(batch_size)+'_num_epochs_'
                                +str(num_epochs)+'_LR_'+str(initLR), entity="bsalafian")
...
model.save(ModelResults+'/'+modelname+'_epoch_'+str(num_epochs)+'_batchsize_'+str(batch_size)+'_LR_'+str(initLR)+'.h5')
...
# i = 0
# all_img_dir = '/home/chb_all_images'

# dirname = '/media/datadrive/6FoldCrossSMILE'
# dir_csv = '/home'
...
# train_gen = My_Custom_Generator(train_file_name, train_label, batch_size)
# validation_gen = My_Custom_Generator(test_file_name, test_label, batch_size)
