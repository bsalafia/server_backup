...
class SeizureDataGenerator(object):
  ...
  def load_samples_modified(self,data_cat,num_csv):
    ...
    data_path = os.path.join(self.dir_csv,f'data_files/{data_cat}')
  ...
  def pkl_read_3times(self,dirname):

    pkl = pickle.load(open(dirname, 'rb'))
    x=pkl.data
    ...
    while True:   
      ...
      for offset in range(0, (num_samples//batch_size)*batch_size, batch_size):
        ...
        for batch_sample in batch_samples:
          ...
          y = batch_sample[1]
          x = self.pkl_read_3times(batch_sample[0][0])
          ind = batch_sample[2]
          # print(ind)
